...
class AppRoutes {
  static Map<String, WidgetBuilder> routes = {
    ...
    RouteName.customerDocumentsScreen: (context) => const CustomerDocumentsScreen(),
    RouteName.customerNotificationScreen: (context) => const CustomerNotificationScreen(),
    RouteName.customerLoanApplicationListScreen: (context) => const CustomerLoanApplicationListScreen(),
    ...
    RouteName.customerLoanApplicationDetailsScreen: (context) {
      final application = ModalRoute.of(context)!.settings.arguments as CustomerLoanApplicationModel;
